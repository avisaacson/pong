...
const CONTACT_INCREASE = 1.05;
const ANGLE_BOUNCE = 3;
...
function adjustAngle(distanceFromTop, distanceFromBottom) {
	if (distanceFromTop < ANGLE_BOUNCE) {
		// If ball hit near top of paddle, reduce ySpeed
		ySpeed -= 0.5;
	} else if (distanceFromBottom < ANGLE_BOUNCE) {
...
function checkCollision() {
	...
	if (checkPaddleCollision(ball, leftPaddle)) {
		...
		xSpeed = Math.abs(xSpeed * CONTACT_INCREASE);
	}
